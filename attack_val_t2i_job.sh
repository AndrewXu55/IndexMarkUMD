#!/bin/bash
#SBATCH --job-name=attack_val
#SBATCH --output=slurm_logs/attacks/%x.out
...
# ==============================================
# attack_val_job.sh
# Inner SLURM script for attack validation.
# Expects environment variables: ALGORITHM, DELTA, RESOLUTION
# ==============================================

echo "========================================="
echo "Attack Validation Job started"
...
INDEX_ENCODER="/cmlscratch/anirudhs/hub/Index_encoder_${RESOLUTION}.pt"
MAPPING_PATH="results/codebook_index_mapping.json"
PAIRS_PATH="results/codebook_pairs.json"
BASE_IMAGE_DIR="/cmlscratch/anirudhs/graph_watermark/images/t2i_experiments"
